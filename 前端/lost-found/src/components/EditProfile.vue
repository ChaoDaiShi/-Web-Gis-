...
const pageStyle = computed(() => {
 ...
 backdropFilter: `blur(${bgBlur.value}px)`
 };
 }
 return {};
});
async function loadUser() {
 ...
 bgImage.value = data.data.bg_image ? `http://127.0.0.1:5000${data.data.bg_image}` : "";
 }
 }
 catch (error) {
...
<template>
  <div class="edit-profile-page" :style="pageStyle" style="overflow-y: auto !important; overflow-x: hidden; min-height: 100vh;">
        ...
        <div class="section">
          ...
          <div class="bg-preview-section">
            ...
            <div class="bg-info">
              ...
              <div v-if="bgImage" class="bg-blur-control">
