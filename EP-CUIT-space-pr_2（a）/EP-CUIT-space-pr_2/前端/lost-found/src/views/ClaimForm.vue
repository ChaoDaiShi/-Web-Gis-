...
function validateForm() {
  if (!formData.value.applicant_phone || !formData.value.applicant_phone.trim()) {
...
<template>
  <div class="profile-page" :style="bgImage ? { background: `url(${bgImage}) center/cover`, minHeight: '100vh' } : {}">
    <div class="topbar">
