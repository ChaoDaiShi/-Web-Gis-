...
function checkAndRestoreDraft() {
  ...
  const currentItemId = route.query.id;
...
async function submitReturn() {
  ...
  try {
    ...
    formDataToSubmit.append('returner_name', formData.value.returner_name);
    formDataToSubmit.append('returner_phone', formData.value.returner_phone);
    ...
    previewImages.value.forEach((image) => {
      formDataToSubmit.append('proof_images', image.file);
    });
    
    console.log('提交的表单数据:', {
      username: formData.value.username,
      returner_name: formData.value.returner_name,
      returner_phone: formData.value.returner_phone,
      return_reason: formData.value.return_reason,
...
function validateForm() {
  console.log('验证表单数据:', {
    returner_phone: formData.value.returner_phone,
    returner_phone_trimmed: formData.value.returner_phone?.trim(),
    returner_phone_length: formData.value.returner_phone?.length
  });
  
  if (!formData.value.returner_phone || !formData.value.returner_phone.trim()) {
      ...
      <div v-else class="form-content">
        ...
        <form @submit.prevent="submitReturn" class="claim-form">
          <div class="form-section">
            ...
            <div class="form-group">
              <label for="returner_name">归还人姓名</label>
              <input 
                id="returner_name"
                v-model="formData.returner_name" 
                type="text" 
            ...
            <div class="form-group">
              <label for="returner_phone">联系方式 *</label>
              <input 
                id="returner_phone"
                v-model="formData.returner_phone" 
                type="tel" 
