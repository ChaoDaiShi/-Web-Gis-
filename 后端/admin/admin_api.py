...
def register_admin_routes(app):
    app.register_blueprint(admin_user_api_bp, url_prefix='/admin')
    app.register_blueprint(admin_item_api_bp, url_prefix='/admin')
    app.register_blueprint(admin_claim_api_bp, url_prefix='/admin')
    app.register_blueprint(admin_return_api_bp, url_prefix='/admin')
    app.register_blueprint(admin_category_api_bp, url_prefix='/admin')
    app.register_blueprint(admin_statistics_api_bp, url_prefix='/admin')
