...
def add_return_form():
    try:
        returner_name = request.form.get('returner_name', '').strip()
        returner_phone = request.form.get('returner_phone', '').strip()
        returner_email = request.form.get('returner_email', '').strip()
        return_reason = request.form.get('return_reason', '').strip()
        return_location = request.form.get('return_location', '').strip()
        user_id = request.form.get('user_id')
        item_id = request.form.get('item_id')
        
        if not returner_phone:
        ...
        cursor.execute("""
            ...
            (item_id, returner_name, returner_phone, returner_email, return_reason, return_location, user_id, proof_images, status, create_time)
