...
def register():
    ...
    try:
        ...
        try:
            ...
            log_action(new_user.user_id, '用户注册', 'user', new_user.user_id, f'用户 {username} 注册成功', request.remote_addr)
        except Exception:
            pass
...
def login():
    ...
    if check_password_hash(user.password_hash, password):
        ...
        try:
            from utils.logger import log_action
            log_action(user.user_id, '用户登录', 'user', user.user_id, f'用户 {user.username} 登录成功', request.remote_addr)
        except Exception:
            pass
...
def admin_login():
    try:
        ...
        if check_password_hash(admin.password_hash, password):
            ...
            try:
                from utils.logger import log_action
                log_action(admin.admin_id, '管理员登录', 'admin', admin.admin_id, f'管理员 {admin.username} 登录成功', request.remote_addr)
            except Exception:
                pass
